...
| [discretize](#cxregions.curves.JuliaCurve.discretize) | Discretize the curve into n points. |
...
##### discretize { #cxregions.curves.JuliaCurve.discretize }

```python
curves.JuliaCurve.discretize(n)
```
...
| Name   | Type   | Description                         | Default    |
|--------|--------|-------------------------------------|------------|
| n      | int    | Number of points to discretize into | _required_ |

###### Returns {.doc-section .doc-section-returns}

| Name   | Type                   | Description                                           |
|--------|------------------------|-------------------------------------------------------|
|        | tuple of numpy.ndarray | Arrays of parameter values and the discretized points |
